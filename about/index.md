...
{{< /style >}}
-->
> [:(far fa-solid fa-keyboard fa-fw): ZLG](https://zhangliguo.com) 是一个**分享**、**记录**关于**互联网项目**、**个人精进**、**数字游民生活**的博客型网站。
>
<!--
...
### 结缘站长（不谈钱只说缘 1万8千元~）
* :(fa-brands fa-weixin): 微信: **暂定**
* :(fa-brands fa-weixin): 公众号：  [**zhangliguo**](https://mp.weixin.qq.com/s/_Y61-WHELeuqauvAP00lnA)
* :(fa-brands fa-youtube): 油管频道名称：**暂定**
<!--
#### 性能和 SEO
